...
function replace() {
  if (redact_profil.innerText == 'Редактировать') {
    ...
    div_redact_profil.innerHTML = '<button id="redact_profil" onclick="replace();" class="redact-button">Отменить</button><br><button name="submit_redact_profil" type="submit" class="save-button">Сохранить</button>'
  } else {
